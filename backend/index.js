...
const app = express();
app.use(cors())
//Learn better way to handel crossorigin request thinks for nodejs(cors or handmade) and django-cors. Tarkista myöhemmin onko oikea tapa tehdä näin tai turvallinen?
